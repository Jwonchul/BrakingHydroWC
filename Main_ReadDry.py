...
df_WHC_brkdist = select_group_data(df, ['RoadInfo', 'Compd'],'Compd', 'DHC', [15,25])
df_WHC_brkdist_high = select_group_data(df, ['RoadInfo', 'Compd'],'Compd', 'DHC', [50,60])
...
plt_group_multi(df,['RoadInfo'],'DHC_20d','DHC_50d')
